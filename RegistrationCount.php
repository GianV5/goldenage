...
<body>
    ...
    <section class="combobox-section">
        <div class="combobox-container">
            <label for="combobox1">Select Barangay:</label>
        ...
        <div class="combobox-container">
            <label for="combobox2">Select District:</label>
            <select id="combobox2" class="combobox">
        ...
        <div class="combobox-container">
            <label for="combobox3">Select Year:</label>
    ...
    <section class="barangay-selection-section">
        <div class="barangay-selection">
            <input type="text" placeholder="Type to add a barangay" class="search-barangay" />
            <div class="barangay-list">
                <label>
                    <input type="checkbox" value="Barangay 1" />
                    Barangay 1
                </label>
                <label>
                    <input type="checkbox" value="Barangay 2" />
                    Barangay 2
                </label>
                <label>
                    <input type="checkbox" value="Barangay 3" />
                    Barangay 3
                </label>
                <label>
                    <input type="checkbox" value="Barangay 4" />
                    Barangay 4
                </label>
